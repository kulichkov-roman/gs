...
/**
 * data-item задаётся в component_epilog.php компонента catalog.element
 */
?>
<div data-product-id="<?itc\CUncachedArea::show('showElementDataProductId');?>" class="goods">
    ...
    if ($ElementID > 0)
    {
        ...
        //pre($arRecomData['IBLOCK_LINK']);
        //pre($arRecomData['ALL_LINK']);
    ...
    <?$APPLICATION->IncludeComponent(
        ...
        Array(
	        ...
	        "USE_CAPTCHA" => "Y",
	        "USER_MESSAGE_EDIT" => "",
	        "USER_MESSAGE_ADD" => "Ваш заказ успешно отправлен!",
	        "DEFAULT_INPUT_SIZE" => "30",
	        "RESIZE_IMAGES" => "N",
	        "PROPERTY_CODES" => array(0=>"192",1=>"NAME",2=>"193"),
	        "PROPERTY_CODES_REQUIRED" => array(0=>"192",1=>"NAME",2=>"193"),
	        "GROUPS" => array(0=>"2",),
	        "STATUS" => "ANY",
